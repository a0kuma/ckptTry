...
from layer_checkpoint import layer_granular_checkpoint
...
y_prime = layer_granular_checkpoint(model, x)
...
# Layer-granular checkpoint forward+backward
...
y_ckpt = layer_granular_checkpoint(model3, x_check)
